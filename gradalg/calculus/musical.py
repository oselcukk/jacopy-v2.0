...
:class:`~gradalg.algebra.derivation.Derivation` atoms parametric in
their generating form / bivector. They are applied via
:class:`~gradalg.algebra.derivation.Act` just like any other
...
* :class:`MusicalCompatibilityDefinition` — an
  :class:`~gradalg.proof.expansion.Definition` that rewrites
...
from gradalg.core.expr import Expr, Neg
from gradalg.proof.expansion import Definition
...
class Flat(Derivation):
    ...
    :class:`~gradalg.calculus.interior.InteriorProduct`.
    """
...
class MusicalCompatibility:
    ...
    rule, or to :meth:`~gradalg.calculus.hamiltonian_vf.HamiltonianVectorField.prove_equivalence`
    ...
    def as_definition(self) -> "MusicalCompatibilityDefinition":
        ...
        :class:`~gradalg.proof.expansion.ExpansionEngine` makes the
    ...
    def musical_definitions(self) -> Tuple[Definition, ...]:
        ...
        axiom on an :class:`~gradalg.proof.expansion.ExpansionEngine`.
        The tuple bundles:
        ...
        :mod:`~gradalg.calculus.hamiltonian_vf` so this module remains
...
class MusicalCompatibilityDefinition(Definition):
    ...
    Registered on an :class:`~gradalg.proof.expansion.ExpansionEngine`
