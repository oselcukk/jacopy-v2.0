...
expression tree — analogous to :class:`gradalg.algebra.derivation.Act`.
...
from gradalg.core.expr import Expr, Neg, Product, Sum
...
def expand_bracket(
    ...
    Matches the :func:`gradalg.algebra.commutator.expand_commutator`
