...
Compared to :class:`~gradalg.brackets.dorfman.DorfmanBracket`:
...
:class:`~gradalg.brackets.dorfman.SectionPair` instances, the vector
...
from gradalg.core.expr import Expr, Neg, Product, Rational, Sum
    ...
    def jacobi_condition(
        ...
        * **H-twisted**: the obstruction is ``dH``. Classical result:
        ...
        if self._background_H is None:
            from gradalg.core.expr import Zero
