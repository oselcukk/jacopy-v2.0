...
from gradalg.core.expr import Expr, Integer
...
def show_equal(
    ...
    *,
    ...
    :class:`gradalg.proof.strategies.ProofFailure` if the chosen
...
def prove_operator_equation(
    ...
    *,
    ...
    property — :class:`~gradalg.calculus.exterior_algebra.ExteriorAlgebra`
...
def unroll_property(prop: Property) -> ProofChain:
    ...
    * :attr:`Provenance.DERIVED` — returns a one-step chain tagged
      ...
      :class:`~gradalg.core.properties.ProofRef` rule and lists the
...
class _PropertyMarker(Expr):
    ...
    name when :meth:`~gradalg.proof.step.ProofStep.format` asks.
    """
