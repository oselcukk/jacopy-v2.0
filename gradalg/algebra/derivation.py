...
graded-Leibniz expansion lives in :mod:`gradalg.algorithms.product_rule`.
...
from gradalg.core.expr import Atom, Expr, Integer, Neg, Product, Rational
...
class Act(Expr):
    ...
    :mod:`gradalg.algorithms.product_rule` pass is the one that rewrites
...
def compose(*ops: Expr) -> Expr:
    ...
    The :mod:`gradalg.algorithms.product_rule` pass is the one that
