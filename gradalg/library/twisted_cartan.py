...
The pattern mirrors :class:`~gradalg.library.lie_algebroid.LieAlgebroid`
— a fresh :class:`~gradalg.calculus.exterior_d.ExteriorDerivative` for
...
:meth:`~gradalg.calculus.cartan.CartanCalculus.verify` threading that
...
class TwistedCartanBundle:
    ...
    vector_bracket
        ...
        Defaults to :data:`gradalg.brackets.lie.lie`.
    name
...
def twisted_cartan_bundle(
    ...
    *,
    ...
    with :func:`gradalg.library.lie_algebroid.lie_algebroid`."""
