...
:class:`~gradalg.calculus.cartan.CartanCalculus` — the exterior
...
from gradalg.brackets.lie import LieBracket, lie as _lie_TM
...
class LieAlgebroid:
    ...
    bracket
        :class:`~gradalg.brackets.base.GradedBracket` on sections of
        ``E``. Graded-antisymmetric, Jacobi, Leibniz assumed (flags on
        the bracket record them; we don't second-guess).
    anchor
        :class:`~gradalg.calculus.anchor.Anchor` ``ρ: E → TM``. Degree
    ...
    vector_bracket
        ...
        the standard :data:`gradalg.brackets.lie.lie` singleton.
    name
    ...
    :class:`~gradalg.core.expr.Expr` operands when a caller invokes
    ...
    def anchor_compatibility_obstruction(
        ...
        Thin forwarder to
        :func:`~gradalg.calculus.anchor.bracket_compatibility_obstruction`
    ...
    def prove_anchor_compatibility(
        ...
        *,
        ...
        :func:`~gradalg.proof.strategies.ExpandAndSimplify`; that path
