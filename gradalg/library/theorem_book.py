...
:class:`~gradalg.proof.chain.ProofChain`, the axiom list it depends on,
...
:class:`~gradalg.proof.strategies.UnrollToFoundations` already drives
...
class Theorem:
    ...
    proof
        ...
        :meth:`gradalg.calculus.cartan.CartanCalculus.verify`.
    notes
